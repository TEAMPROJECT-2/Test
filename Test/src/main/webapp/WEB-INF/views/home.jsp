                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="active">
                                    <a href="index.html">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">홈으로</span>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li>
                                    <a href="form-elements-component.html">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">상품등록</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="bs-basic-table.html">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">재고관리</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="bs-basic-table.html">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">주문목록</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                      <div class="row">
                                            ...
                                            <!-- order-card start  상단 박스-->
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-blue order-card">
                                                    <div class="card-block">
                                                        <h6 class="m-b-20">받은 주문</h6>
                                                        <h2 class="text-right"><i class="ti-shopping-cart f-left"></i><span>486</span></h2>
                                                        <p class="m-b-0">처리한 주문<span class="f-right">351</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-green order-card">
                                                    <div class="card-block">
                                                        <h6 class="m-b-20">상품 총판매 갯수</h6>
                                                        <h2 class="text-right"><i class="ti-tag f-left"></i><span>1641</span></h2>
                                                        <p class="m-b-0">이번달<span class="f-right">213</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-yellow order-card">
                                                    <div class="card-block">
                                                        <h6 class="m-b-20">총 매출</h6>
                                                        <h2 class="text-right"><i class="ti-reload f-left"></i><span>$42,562</span></h2>
                                                        <p class="m-b-0">이번달 매출<span class="f-right">$5,032</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-pink order-card">
                                                    <div class="card-block">
                                                        ...
                                                        <p class="m-b-0">이번달 매출<span class="f-right">$542</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- order-card end 상단 박스 끝 -->

                                            <!-- 그래프 statustic and process start -->
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="row justify-content-center m-t-15">
                                                            <div class="col-auto b-r-default m-t-5 m-b-5">
                                                                <h4>50%</h4>
                                                                <p class="text-success m-b-0"><i class="ti-hand-point-up m-r-5"></i>긍정</p>
                                                            </div>
                                                            <div class="col-auto m-t-5 m-b-5">
                                                                <h4>50%</h4>
                                                                <p class="text-danger m-b-0"><i class="ti-hand-point-down m-r-5"></i>부정</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--그래프 statustic and process end -->
											
											
											<!--중앙 상품 주문 상태 박스 tabs card start -->
                                            <div class="col-sm-12">
                                                <div class="card tabs-card">
                                                    <div class="card-block p-0">
                                                        ...
                                                        <ul class="nav nav-tabs md-tabs" role="tablist">
                                                            <li class="nav-item">
                                                                <a class="nav-link active" data-toggle="tab" href="#home3" role="tab"><i class="ti-eye"></i>최근 주문 목록</a>
                                                                <div class="slide"></div>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link" data-toggle="tab" href="#profile3" role="tab"><i class="ti-shopping-cart"></i>발송전</a>
                                                                <div class="slide"></div>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link" data-toggle="tab" href="#messages3" role="tab"><i class="ti-truck"></i>배송중/완료</a>
                                                                <div class="slide"></div>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link" data-toggle="tab" href="#settings3" role="tab"><i class="fa fa-database"></i>환불</a>
                                                                <div class="slide"></div>
                                                            </li>
                                                        </ul>
                                                        <!-- Tab panes -->
                                                            ...
                                                            <div class="tab-pane active" id="home3" role="tabpanel">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table">
                                                                        ...
                                                                        <tr>
                                                                            <td><img src="resources/assets/images/product/prod2.jpg" alt="prod img" class="img-fluid"></td>
                                                                            <td>PNG002344</td>
                                                                            <td>John Deo</td>
                                                                            <td>05-01-2017</td>
                                                                        ...
                                                                        <tr>
                                                                            <td><img src="resources/assets/images/product/prod3.jpg" alt="prod img" class="img-fluid"></td>
                                                                            <td>PNG002653</td>
                                                                            <td>Eugine Turner</td>
                                                                            <td>04-01-2017</td>
                                                                            <td><span class="label label-success">발송완료</span></td>
                                                                            <td>#7234417</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><img src="resources/assets/images/product/prod4.jpg" alt="prod img" class="img-fluid"></td>
                                                                            <td>PNG002156</td>
                                                                            <td>Jacqueline Howell</td>
                                                                            <td>03-01-2017</td>
                                                                            <td><span class="label label-warning">발송중</span></td>
                                                                            <td>#7234454</td>
                                                                        </tr>
                                                                    </table>
                                                                </div>
                                                                <div class="text-center">
                                                                    <button class="btn btn-outline-primary btn-round btn-sm">더보기</button>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>Eugine Turner</td>
                                                                            <td>04-01-2017</td>
                                                                            <td><span class="label label-inverse">미발송</span></td>
                                                                            <td>#7234417</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><img src="resources/assets/images/product/prod4.jpg" alt="prod img" class="img-fluid"></td>
                                                            ...
                                                            <div class="tab-pane" id="messages3" role="tabpanel">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table">
                                                                        ...
                                                                        <tr>
                                                                            <td><img src="resources/assets/images/product/prod1.jpg" alt="prod img" class="img-fluid"></td>
                                                                            <td>PNG002413</td>
                                                                            <td>Jane Elliott</td>
                                                                            <td>06-01-2017</td>
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>Jane Elliott</td>
                                                                            <td>06-01-2017</td>
                                                                            <td><span class="label label-primary">환불완료</span></td>
                                                                            <td>#7234421</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><img src="resources/assets/images/product/prod2.jpg" alt="prod img" class="img-fluid"></td>
...
<!--                                                         <i class="fa fa-envelope-open text-c-blue d-block f-40"></i> -->
                                                        ...
                                                        <i class="icofont icofont-eye-alt"></i></button>
                                                        <h4 class="m-t-20"><span class="text-c-red">12개항목</span> 품절임박</h4>
                                                        <p class="m-b-20"></p>
                                                        <button class="btn btn-danger btn-sm btn-round">더보기</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-lg-4">
                                                <div class="card">
                                                    <div class="card-block text-center">
                                                    <button class="btn btn-inverse btn-icon">
                                                        <i class="icofont icofont-info-square"></i></button>
                                                        <h4 class="m-t-20">재고량</h4>
                                                        <p class="m-b-20"></p>
                                                        <button class="btn btn-inverse btn-sm btn-round">더보기</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-lg-4">
                                                <div class="card">
                                                    <div class="card-block text-center">
                                                        ...
                                                        <h4 class="m-t-20">판매량</h4>
                                                        <p class="m-b-20"></p>
                                                        <button class="btn btn-primary btn-sm btn-round">더보기</button>
                                                    </div>
                                                </div>
                                            </div>
...
<!--                                                                     <img src="resources/assets/images/avatar-3.jpg" class="img-radius " alt="User-Profile-Image"> -->
<!--                                                                 </div> -->
...
<!--                                                                         <img src="resources/assets/images/blog/blog-r-1.jpg" alt="img" class="img-fluid img-100"> -->
<!--                                                                         <h6 class="m-t-15 m-b-0">Old Scooter</h6> -->
<!--                                                                         <p class="text-muted m-b-0"><small>PNG-100KB</small></p> -->
<!--                                                                     </div> -->
<!--                                                                     <div class="col-auto text-center"> -->
<!--                                                                         <img src="resources/assets/images/blog/blog-r-2.jpg" alt="img" class="img-fluid img-100"> -->
<!--                                                                         <h6 class="m-t-15 m-b-0">Wall Art</h6> -->
<!--                                                                         <p class="text-muted m-b-0"><small>PNG-150KB</small></p> -->
<!--                                                                     </div> -->
<!--                                                                     <div class="col-auto text-center"> -->
<!--                                                                         <img src="resources/assets/images/blog/blog-r-3.jpg" alt="img" class="img-fluid img-100"> -->
...
<!--                                                             <li class="diactive-feed"> -->
<!--                                                                 <div class="feed-user-img"> -->
<!--                                                                     <img src="resources/assets/images/avatar-2.jpg" class="img-radius " alt="User-Profile-Image"> -->
<!--                                                                 </div> -->
...
<!-- Custom js -->
<script type="text/javascript" src="resources/assets/pages/dashboard/custom-dashboard.min.js"></script>
<script type="text/javascript" src="resources/assets/js/script.js"></script>
<script type="text/javascript " src="resources/assets/js/SmoothScroll.js"></script>
<script src="resources/assets/js/pcoded.min.js"></script>
<script src="resources/assets/js/vartical-demo.js"></script>
